//! frp2p-client-gui: stub library for the future GUI frontend.
//!
...
//! ## Roadmap
//!
//! - v1.1: minimal `egui` or `iced` shell that wraps `frp2p-client`:
...
//!
//! The GUI process will reuse the same library (`frp2p_common`) as the
//! CLI client, so configuration parsing, ALPN derivation, and tunnel
//! bridging logic stay identical.

#![doc(html_root_url = "https://docs.rs/frp2p-client-gui/0.1.0")]

/// Returns a constant string identifying this placeholder.
pub fn placeholder() -> &'static str {
    "frp2p-client-gui: placeholder; GUI not implemented in v1"
}
